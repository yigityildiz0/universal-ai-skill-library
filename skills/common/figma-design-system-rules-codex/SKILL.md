---
name: figma-design-system-rules-codex
description: "Generates custom design system rules for the user's codebase. Use when user says \"create design system rules\", \"generate rules for my project\", \"set up. Turkish triggers: Figma tasarım sistemi kurallarını Codex için çıkar, Figma yönergesi oluştur."
---
...
|-------|-----------|-------|
| Codex | `AGENTS.md` in project root | Markdown format. Can also use `AGENTS.md or skill rulesfigma-design-system.md` for modular organization. |
...
## Examples
Read [references/examples.md](references/examples.md) for React/Tailwind, Vue/custom-CSS, and design-system-team rule examples.
