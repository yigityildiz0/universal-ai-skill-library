---
name: market-finder
description: 'Discovers all businesses of a given type in any geography using Nimble WSAs. Two modes: Discovery finds businesses from scratch; Audit compares a user''s.'
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
