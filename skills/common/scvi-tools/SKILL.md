...
4. For installation or GPU issues, consult `references/environment_setup.md`; use an isolated environment, verify current official compatibility guidance, and never silently upgrade a working analysis environment
