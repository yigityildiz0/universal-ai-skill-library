---
name: meeting-prep
description: Researches meeting attendees and their companies before any meeting using real-time web data. Surfaces roles, recent activity, company context, and talking.
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
