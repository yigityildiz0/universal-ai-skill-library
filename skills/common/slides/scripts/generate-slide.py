...
def main():
    ...
    if args.demo:
        ...
        demo_slides = [
            {
                ...
                'subtitle': 'Turn operational data into clear decisions.',
                'cta': 'Join Waitlist',
            ...
            {
                'type': 'solution',
                'headline': 'Analytics that teams can act on',
            ...
            {
                'type': 'testimonial',
                'quote': 'Northstar replaced three disconnected reports and cut weekly analysis time by 60%.',
                'author': 'Sarah Chen',
        ...
        html = generate_deck(demo_slides, "Northstar Analytics - Pitch Deck")
