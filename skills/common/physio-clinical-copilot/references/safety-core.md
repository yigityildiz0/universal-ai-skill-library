...
This consolidated skill routes directly to its local reference modules. When it also names an external research or domain skill, use it only when actually available; otherwise apply the local workflow and disclose any resulting evidence limitation.
