...
description: Extracts structured practitioner data from healthcare practice websites. Returns names, credentials, specialties, contact info, and education for every.
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
