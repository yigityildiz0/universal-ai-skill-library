...
description: Systematic architectural thinking for irreplaceable human capabilities - domain modeling, systems thinking, constraint navigation, and AI-aware problem.
---
...
1. **Document your commitments** - Put architectural decisions in files AI can read (AGENTS.md, ARCHITECTURE.md)
