---
name: chatgpt-apps
description: "Build, scaffold, refactor, and troubleshoot ChatGPT Apps SDK applications that combine an MCP server and widget UI. Use when Codex needs to design tools. Turkish triggers: ChatGPT uygulaması yap, Apps SDK, MCP sunucusu ve widget, ChatGPT app hatası."
---
