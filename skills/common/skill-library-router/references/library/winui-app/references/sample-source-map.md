...
| --- | --- | --- |
| Check whether a PC can build WinUI apps | `../INSTRUCTIONS.md` | `foundation-environment-audit-and-remediation.md` |
| Install missing prerequisites | `../INSTRUCTIONS.md` | `foundation-environment-audit-and-remediation.md` |
| Start a new packaged or unpackaged app | `../INSTRUCTIONS.md` | `foundation-setup-and-project-selection.md` |
