...
- The setup-and-scaffold flow in [../INSTRUCTIONS.md](../INSTRUCTIONS.md) for prerequisite setup, template verification, and the first scaffold.
...
- Use the setup-and-scaffold flow in [../INSTRUCTIONS.md](../INSTRUCTIONS.md) for prerequisite setup, template verification, and the first scaffold.
...
- For either packaging model, scaffold first through the setup flow in `INSTRUCTIONS.md` and continue from the generated project instead of copying in prebuilt baseline files.
...
- Is the machine baseline actually verified through the setup-and-scaffold flow in `INSTRUCTIONS.md`?
