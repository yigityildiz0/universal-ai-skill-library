...
**`router.back()` and browser back/forward skip animation:** Use `router.push()` with an explicit URL instead. See INSTRUCTIONS.md "router.back() and Browser Back Button."
