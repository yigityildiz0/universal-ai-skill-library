...
Get live web data instantly — fetch any URL, scrape structured data, search the web, map sites, and capture XHR APIs. The only way the assistant can access live websites.
...
Gives the assistant direct access to the full Nimble documentation — CLI flags, schemas, API reference.
...
| `references/nimble-extract/INSTRUCTIONS.md`                 | Full `nimble extract` flag reference                          |
...
| `references/nimble-search/INSTRUCTIONS.md`                  | `nimble search` flag reference                                |
| `references/nimble-search/search-focus-modes.md`     | 8 focus modes (news, web, jobs, etc.)                         |
| `references/nimble-map/INSTRUCTIONS.md`                     | `nimble map` URL discovery reference                          |
| `references/nimble-crawl/INSTRUCTIONS.md`                   | `nimble crawl` bulk extraction reference                      |
| `references/nimble-agents/INSTRUCTIONS.md`                  | `nimble agent` CLI reference                                  |
