...
This guidance is intentionally isolated from `INSTRUCTIONS.md` because it can vary by environment and may become stale. Prefer the defaults in your environment when in doubt.
