...
Cross-agent entry point for the Vercel Optimize skill. The full procedure is in [INSTRUCTIONS.md](./INSTRUCTIONS.md).
...
`.agents/skills/vercel-optimize/INSTRUCTIONS.md` before proposing changes.
