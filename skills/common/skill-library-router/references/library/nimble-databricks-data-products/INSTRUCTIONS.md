...
description: 'Builds Databricks data products from live web data, end to end: discovers the right Nimble web-data agents, scrapes into Delta tables, and produces an AI/BI.'
allowed-tools:
- Bash(databricks:*)
- Bash(python3:*)
- Bash(bash:*)
