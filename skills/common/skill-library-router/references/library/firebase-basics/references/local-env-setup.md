...
To fully manage Firebase, the agent needs specific skills and the Firebase MCP server installed. Refer to the main `INSTRUCTIONS.md` for direct links to the installation instructions specific to your agent environment.
