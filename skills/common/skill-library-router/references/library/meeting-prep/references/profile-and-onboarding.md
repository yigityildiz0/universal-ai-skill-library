...
#### Preferred path — any the assistant product (opencode, the assistant Cowork, claude.ai)
...
This works in every the assistant product (Code, Cowork, claude.ai) — they share the
...
#### Cursor, VS Code, or other MCP clients outside the the assistant family
