...
description: 'Use this skill ANY TIME the user asks about a specific company. Triggers: "tell me about [company]", "research [company]", "what does [company] do", "who is.'
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
