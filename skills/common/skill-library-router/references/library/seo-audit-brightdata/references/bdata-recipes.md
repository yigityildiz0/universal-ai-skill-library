...
- If `bdata` is missing or unauthenticated, stop immediately and point the user at the prerequisites section in INSTRUCTIONS.md and the `brightdata-cli` skill.
