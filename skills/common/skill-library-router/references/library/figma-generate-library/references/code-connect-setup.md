> Part of the [figma-generate-library skill](../INSTRUCTIONS.md).
...
Map Code Connect immediately after creating a component, while the context is fresh (Phase 3, step 3h in the INSTRUCTIONS.md workflow):
