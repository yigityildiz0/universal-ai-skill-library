...
4. **Return to main INSTRUCTIONS.md workflow** after data preparation is complete
...
Then return to the main INSTRUCTIONS.md workflow (Step 1: Environment Check) to proceed with pipeline execution.
...
# 4. Run nf-core/rnaseq (continue with main INSTRUCTIONS.md workflow)
nextflow run nf-core/rnaseq \
    --input samplesheet.csv \
    --outdir results \
    --genome R64-1-1 \
