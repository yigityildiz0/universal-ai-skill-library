...
Stage 5b of `INSTRUCTIONS.md` requires a concrete measurement plan for any paid spend. Platforms
...
In Stage 5b of `INSTRUCTIONS.md`, produce a specific, named experiment from one of these templates.
...
Stage 4 of `INSTRUCTIONS.md` forbids broad cold-paid for severe / categorical asymmetry. For mild
