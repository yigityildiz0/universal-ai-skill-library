---
name: local-places
description: Discovers, enriches, and scores local businesses in any neighborhood using Nimble Web Search Agents (WSAs) and web data. Returns a structured, ranked list.
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
