...
- **Compare function, not form**: A Makefile and a justfile serve the same purpose. A `.cursorrules` file and a `$CODEX_HOME/skills/INSTRUCTIONS.md` file may encode the same knowledge differently. Look past the format to the capability.
