...
See INSTRUCTIONS.md Step 2 for the matching and selection flow.
...
see INSTRUCTIONS.md Step 7 for SaaS-specific scoring based on funding, directory presence,
and review counts.
