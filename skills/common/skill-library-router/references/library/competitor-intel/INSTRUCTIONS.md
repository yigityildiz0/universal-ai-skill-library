...
description: Searches the live web via Nimble APIs to monitor competitors and produce a structured intelligence briefing. Runs parallel searches for news, product.
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
