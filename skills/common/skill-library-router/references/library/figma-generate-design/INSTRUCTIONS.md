...
description: 'Use this skill alongside figma-use when the task involves translating an application page, view, or multi-section layout into Figma. Triggers: ''write to.'
---
...
**MANDATORY**: You MUST also load [figma-use](../figma-use/INSTRUCTIONS.md) before any `use_figma` call. That skill contains critical rules (color ranges, font loading, etc.) that apply to every script you write.
...
- If the user wants to generate **code from a Figma design**, switch to [figma-implement-design](../figma-implement-design/INSTRUCTIONS.md).
- If the user wants to create **new reusable components or variants**, use [figma-use](../figma-use/INSTRUCTIONS.md) directly.
- If the user wants to write **Code Connect mappings**, switch to [figma-code-connect-components](../figma-code-connect-components/INSTRUCTIONS.md).
...
For detailed API patterns and gotchas, load these from the [figma-use](../figma-use/INSTRUCTIONS.md) references as needed:
...
Follow the error recovery process from [figma-use](../figma-use/INSTRUCTIONS.md#6-error-recovery--self-correction):
