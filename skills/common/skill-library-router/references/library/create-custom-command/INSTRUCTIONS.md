...
Creates reusable Codex skills under `%USERPROFILE%\.codex\skills\<workflow-name>\INSTRUCTIONS.md`. Convert any external slash-command style workflow into a `INSTRUCTIONS.md` with clear trigger phrases and instructions.
...
### Step 2: Create INSTRUCTIONS.md Files

Each workflow lives in `%USERPROFILE%\.codex\skills\<workflow-name>\INSTRUCTIONS.md`. Codex can use it by skill name or when a request matches the description and trigger phrases.

#### Example: Code Review Workflow

```markdown
<!-- %USERPROFILE%\.codex\skills\review\INSTRUCTIONS.md -->
# Code Review Command
...
```markdown
<!-- %USERPROFILE%\.codex\skills\test\INSTRUCTIONS.md -->
...
```markdown
<!-- %USERPROFILE%\.codex\skills\document\INSTRUCTIONS.md -->
...
```markdown
<!-- %USERPROFILE%\.codex\skills\onboard\INSTRUCTIONS.md -->
# Codebase Onboarding
...
```markdown
<!-- %USERPROFILE%\.codex\skills\pr\INSTRUCTIONS.md -->
...
```markdown
<!-- %USERPROFILE%\.codex\skills\fix\INSTRUCTIONS.md -->
# Fix Issue Command
...
```markdown
<!-- %USERPROFILE%\.codex\skills\scaffold\INSTRUCTIONS.md -->
# Scaffold Component
...
```markdown
<!-- %USERPROFILE%\.codex\skills\standup\INSTRUCTIONS.md -->
...
```markdown
<!-- %USERPROFILE%\.codex\skills\release\INSTRUCTIONS.md -->
# Prepare Release
...
```markdown
<!-- %USERPROFILE%\.codex\skills\full-review\INSTRUCTIONS.md -->
# Full Code Review
