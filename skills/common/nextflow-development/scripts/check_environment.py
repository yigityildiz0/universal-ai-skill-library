...
def check_nextflow() -> CheckResult:
    ...
    if not shutil.which("nextflow"):
        return CheckResult(
            ...
            fix="Follow current official Nextflow installation guidance after approval; inspect the artifact and verify it in an isolated or known environment."
        )
        ...
        if match:
            ...
            if major > 23 or (major == 23 and minor >= 4):
                ...
                return CheckResult(
                    ...
                    details=version_line,
                    fix="Review official release notes and test a newer version separately; do not self-update a working analysis environment."
                )
