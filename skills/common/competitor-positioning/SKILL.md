...
description: Tracks how competitors position themselves online — scrapes homepages, features, pricing, and blogs to extract messaging, value props, CTAs, and pricing.
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
