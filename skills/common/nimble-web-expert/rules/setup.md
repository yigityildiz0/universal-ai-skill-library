---
description: One-time setup instructions for Nimble — plugin install (the assistant products), CLI install (terminal agents), or manual MCP config (Cursor/VS Code). Load this only when the quick check in SKILL.md fails.
alwaysApply: false
---
