...
description: Fills gaps in existing healthcare practitioner lists — adds missing phone numbers, credentials, specialties, contact info, education, reviews, and.
allowed-tools:
- Bash(nimble:*)
- Bash(date:*)
- Bash(cat:*)
