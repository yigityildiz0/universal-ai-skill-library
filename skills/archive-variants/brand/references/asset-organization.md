...
| campaign | kebab-case | Yes* | spring-launch, q1-promo, evergreen |
...
### Examples
```
banner_spring-launch_hero-image_20251209_16-9.png
...
```json
{
  ...
  "type": "banner",
  "path": "assets/banners/landing-pages/banner_spring-launch_hero-image_20251209.png",
...
```json
{
  "version": 2,
  "previousVersion": 1,
  "path": "assets/banners/landing-pages/banner_spring-launch_hero-image_20251209_v2.png",
...
grep -l "spring-launch" .assets/manifest.json
```
