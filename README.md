<p align="center">
  <a href="CATALOG.md"><picture><source media="(max-width: 640px)" srcset="assets/library-hero-mobile.svg"><img src="assets/library-hero.svg" alt="Universal AI Skill Library: 531 searchable Agent Skills mapped across Claude Code, OpenAI Codex, and OpenCode" width="100%"></picture></a>
</p>
...
<p align="center">
  ...
  <a href="CATALOG.md">Browse all 531</a> ·
...
<p align="center">
  <img src="https://img.shields.io/badge/skills-531-718cff?style=flat-square" alt="531 indexed skills">
...
| Install a practical starter library | [Choose a curated platform bundle](#download-for-your-agent) | Installs 100–106 top-level skills plus `skill-library-router` for progressive discovery. |
...
|---|---|---|---|
| **Claude Code** | [⬇ 100 skills · ~15.1 MiB](https://github.com/yigityildiz0/universal-ai-skill-library/releases/latest/download/universal-ai-skill-library-claude.zip) | [⬇ 524 entries · ~28.4 MiB](https://github.com/yigityildiz0/universal-ai-skill-library/releases/latest/download/universal-ai-skill-library-claude-expanded.zip) | `~/.claude/skills/` |
| **OpenAI Codex** | [⬇ 106 skills · ~15.2 MiB](https://github.com/yigityildiz0/universal-ai-skill-library/releases/latest/download/universal-ai-skill-library-codex.zip) | [⬇ 530 entries · ~28.6 MiB](https://github.com/yigityildiz0/universal-ai-skill-library/releases/latest/download/universal-ai-skill-library-codex-expanded.zip) | `~/.agents/skills/` |
| **OpenCode** | [⬇ 101 skills · ~15.1 MiB](https://github.com/yigityildiz0/universal-ai-skill-library/releases/latest/download/universal-ai-skill-library-opencode.zip) | [⬇ 525 entries · ~28.5 MiB](https://github.com/yigityildiz0/universal-ai-skill-library/releases/latest/download/universal-ai-skill-library-opencode-expanded.zip) | `~/.config/opencode/skills/` |
...
1. **Discover:** search 531 names by task or category.
...
|---|---:|---|---:|
| Specialized integrations | 143 | Design, UI, and UX | 75 |
| Coding and architecture | 63 | Business and productivity | 42 |
| Testing, debugging, and quality | 40 | Documents and data | 35 |
| Agents and context | 33 | Security and compliance | 29 |
| Cloud and DevOps | 26 | Media and creative | 20 |
| Research and reasoning | 18 | Science and bioscience | 7 |
...
- Include **100 Claude**, **106 Codex**, or **101 OpenCode** skills.
...
- Install every compatible catalog name directly: **524 / 530 / 525**.
...
<details>
<summary><strong>Do all 531 skills work identically on all three agents?</strong></summary>

No. There are 531 unique names; 524 map to Claude Code, 530 to Codex, and 525 to OpenCode. Format compatibility does not prove that every dependency, external service, or platform-specific behavior was executed successfully. Read the catalog note for the skill.
</details>
